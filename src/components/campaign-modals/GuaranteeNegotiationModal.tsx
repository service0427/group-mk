                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-blue-600 dark:text-blue-400">
                          (VAT 포함: {requestInfo.final_budget_type === 'total' && requestInfo.final_total_amount
                            ? smartCeil(requestInfo.final_total_amount * 1.1).toLocaleString()
                            : smartCeil(requestInfo.final_daily_amount * requestInfo.guarantee_count * 1.1).toLocaleString()}원)
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between mt-2 p-2 bg-orange-50 dark:bg-orange-900/20 rounded-md">
                      ...
                      <div className="text-right">
                        <span className="text-xl font-bold text-orange-600 dark:text-orange-400">
                          {requestInfo.final_budget_type === 'total' && requestInfo.final_total_amount
                            ? smartCeil(requestInfo.final_total_amount * 1.1).toLocaleString()
                            : smartCeil(requestInfo.final_daily_amount * finalGuaranteeCount * 1.1).toLocaleString()}원
                        </span>
                  ...
                  <div className="text-sm text-red-800 dark:text-red-300">
                    ...
                    <ul className="space-y-1 text-xs">
                      ...
                      <li>• 잔액에서 <span className="font-bold">{requestInfo && (
                        requestInfo.final_budget_type === 'total' && requestInfo.final_total_amount
                          ? smartCeil(requestInfo.final_total_amount * 1.1).toLocaleString()
                          : smartCeil(requestInfo.final_daily_amount * requestInfo.guarantee_count * 1.1).toLocaleString()
