...
const AVAILABLE_COLUMNS = [
  ...
  { field: 'main_keyword', label: '메인키워드', width: 20 },
  { field: 'keyword1', label: '서브키워드1', width: 15 },
  { field: 'keyword2', label: '서브키워드2', width: 15 },
  { field: 'keyword3', label: '서브키워드3', width: 15 },
  { field: 'url', label: 'URL', width: 30 },
