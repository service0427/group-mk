      ...
      <DialogContent className="sm:max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 bg-background overflow-y-auto flex-1">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-lg p-4 mb-6">
            ...
            {slot.keywords && (
              <div className="mt-4">
                <span className="text-blue-600 dark:text-blue-400 font-medium flex items-center text-sm">
            ...
            {slot.url && (
              <div className="mt-4">
                <span className="text-purple-600 dark:text-purple-400 font-medium flex items-center text-sm">
                  <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="max-h-60 overflow-y-auto">
                ...
                {dateRange.map((date, index) => {
                  ...
                  return (
                    <div 
                      key={index}
                      className={`grid grid-cols-7 gap-1 py-2 text-xs border-b border-gray-100 dark:border-gray-700 ${
                    ...
                    >
                      ...
                      <div className="text-gray-500 dark:text-gray-400 col-span-4">
                        {work?.notes || '-'}
                      </div>
                    </div>
                  );
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800/50 rounded-lg p-4">
            <h4 className="text-sm font-medium text-orange-900 dark:text-orange-300 mb-3 flex items-center">
              <svg className="w-4 h-4 mr-2 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 00-2-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
              </svg>
              작업 통계
            </h4>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-900 dark:text-white font-medium">
                  {stats.requestDate ? stats.requestDate.toLocaleDateString() : '-'}
                </span>
              </div>
              <div>
                <span className="text-gray-500 dark:text-gray-400">최근 작업 완료일:</span>
                <span className="ml-2 text-gray-900 dark:text-white font-medium">
                  {stats.lastWorkDate ? stats.lastWorkDate.toLocaleDateString() : '-'}
                </span>
              </div>
            </div>
          </div>
