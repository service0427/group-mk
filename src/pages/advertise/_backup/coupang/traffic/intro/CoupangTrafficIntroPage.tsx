...
import { CoupangTrafficIntroContent } from '.';
...
const CoupangTrafficIntroPage = () => {
    ...
    const image = (
        <img
            src={toAbsoluteUrl('/media/ad-brand/coupang-app.png')}
        ...
        <Fragment>
            <Container>
                ...
                <IntroLogo
                    ...
                    image={image}
                    info={[
                        { label: 'COUPANG 트래픽의 캠페인을 소개합니다.', icon: 'information-3 text-primary' },
                    ]}
                />
            </Container>
            <Container>
                <CoupangTrafficIntroContent mode="cards" />
            </Container>
        </Fragment>
    );
};

export { CoupangTrafficIntroPage };
