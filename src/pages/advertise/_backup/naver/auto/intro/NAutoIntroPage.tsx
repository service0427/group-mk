        ...
        <Fragment>
            <Container>
                ...
                <IntroLogo
                    ...
                    image={image}
                    info={[
                        { label: 'NAVER 자동완성의 캠페인을 소개합니다.', icon: 'information-3 text-primary' },
                    ]}
                />
            </Container>
            <Container>
                <NAutoIntroContent mode="cards" />
            </Container>
        </Fragment>
    );
};

export { NAutoIntroPage };
