...
import { NPlaceSaveIntroContent } from '.';
    ...
    return (
        <Fragment>
            <Container>
                ...
                <IntroLogo
                    name="NAVER 플레이스 위치저장"
                    image={image}
                    info={[
                        { label: 'NAVER 플레이스 위치저장의 캠페인을 소개합니다.', icon: 'information-3 text-primary' },
                    ]}
                />
            </Container>
            <Container>
                <NPlaceSaveIntroContent mode="cards" />
            </Container>
        </Fragment>
    );
};

export { NPlaceSaveIntroPage };
