...
import { NShoppingTrafficIntroContent } from '.';
...
const NShoppingTrafficIntroPage = () => {
    ...
    const image = (
        <img
            src={toAbsoluteUrl('/media/ad-brand/naver-shopping.png')}
        ...
        <Fragment>
            <Container>
                ...
                <IntroLogo
                    ...
                    image={image}
                    info={[
                        { label: 'NAVER 쇼핑 트래픽의 캠페인을 소개합니다.', icon: 'information-3 text-primary' },
                    ]}
                />
            </Container>
            <Container>
                <NShoppingTrafficIntroContent mode="cards" />
            </Container>
        </Fragment>
    );
};

export { NShoppingTrafficIntroPage };
