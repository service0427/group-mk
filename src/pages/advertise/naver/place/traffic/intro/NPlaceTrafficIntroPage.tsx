...
import { NPlaceTrafficIntroContent } from '.';
        ...
        <Fragment>
            <Container>
                ...
                <IntroLogo
                    ...
                    image={image}
                    info={[
                        { label: 'NAVER 플레이스 트래픽의 캠페인을 소개합니다.', icon: 'information-3 text-primary' },
                    ]}
                />
            </Container>
            <Container>
                <NPlaceTrafficIntroContent mode="cards" />
            </Container>
        </Fragment>
    );
};

export { NPlaceTrafficIntroPage };
