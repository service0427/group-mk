    ...
    <>
      ...
      <GuaranteeRefundModal
        ...
        totalAmount={refundModal.requestData?.final_daily_amount ?
          Math.ceil(refundModal.requestData.final_daily_amount * (refundModal.requestData.guarantee_period || refundModal.requestData.guarantee_count || 0) * 1.1) : 0}
      ...
      {refundModal.requestData && refundModal.requestData.guarantee_slots?.[0] && (
        <GuaranteeRefundModal
          ...
          totalAmount={refundModal.requestData.final_daily_amount ? Math.ceil(refundModal.requestData.final_daily_amount * (refundModal.requestData.guarantee_period || refundModal.requestData.guarantee_count) * 1.1) : 0}
