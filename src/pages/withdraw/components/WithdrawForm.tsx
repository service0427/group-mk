...
const WithdrawForm: React.FC<WithdrawFormProps> = ({ userId, onSuccess, userCashBalance }) => {
  ...
  return (
    <div>
      ...
      <div className="mt-auto">
        <button 
          ...
          className={`w-full py-4 ${
            customAmount && Number(customAmount) > 0 && bankName && accountNumber && accountHolder && !isLoading 
      ...
      {toast.visible && (
        <div 
          className={`fixed bottom-4 right-4 z-50 max-w-md p-4 rounded-lg shadow-lg border transition-opacity duration-300 ${
            toast.type === 'success' 
