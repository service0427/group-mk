...
const MegaMenuSubAdmin = (items: TMenuConfig, itemIndex: number = 3) => {
  ...
  const userManagement = adminItem.children ? adminItem.children[0] : {};
  const campaignManagement = adminItem.children ? adminItem.children[1] : {};
  const slotManagement = adminItem.children ? adminItem.children[2] : {};
